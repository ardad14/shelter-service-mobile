...
class ShelterInformationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_shelter_information, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ShelterInformationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ShelterInformationFragment().apply {
